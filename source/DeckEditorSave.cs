			...
			if (flag)
			{
				if (scene.get_Validator().IsSaveValid(out failure))
				{
					...
					if (save.get_Success())
					{
						...
						{
							DataComposition dataComposition = global::h.o.Create(global::L.LT(Constants.FO()), global::L.LT(Constants.Fo(), new object[]
							{
							...
							dataComposition.Add<global::e.b>(new global::e.b(Constants.Fp()));
					...
					{
						DataComposition dataComposition2 = global::h.o.Create(global::L.LT(Constants.FQ()), global::L.LT(Constants.Fq()), false, new string[]
						{
							global::L.LT(Constants.FP())
						});
						dataComposition2.Add<global::e.b>(new global::e.b(Constants.Fp()));
